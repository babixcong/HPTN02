        ...
        <div class="main-content-inner">
            <div class="row">
               <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Danh sách vé</h4>
                                ...
                                <table id="table-ve" class="text-center">
                                    ...
                                    <c:forEach items="${list}" var="ve" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>${ve.getTen()}</td>
                                            <td>
                                                <img src="${ve.getHinhanh()}" onerror="this.src='${pageContext.request.contextPath}/images/default-image.jpg'" width="50" class="img-thumbnail"/>
                                            </td>
                                            <td>${ve.getLoaive()}</td>
                                            <td>
                                            ...
                                            <td style="width: 300px">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <button type="button" data-value="${ve.getId()}" data-code="${ve.getMava()}" data-kind="MUA" data-type="VE" class="btn btn-success add-to-cart">Thêm vào đơn hàng</button>
                                                    </div>
                                                    <div class="col-6">
                                                        <button type="button" data-value="${ve.getId()}" data-type="VE" class="add-to-gift btn btn-warning ">Thêm vào quà</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
